...
class _MissionCompService implements MissionCompService {
  ...
  Future<HttpResponse<List<MissionComplete>>> missionCompBymcId(
      {required mcID}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'mcID': mcID};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<MissionComplete>>>(Options(
  ...
  @override
  Future<HttpResponse<List<MissionComplete>>> missionCompByraceId(
  ...
  @override
  Future<HttpResponse<List<MissionComplete>>> missionCompByraceIdApprove(
      {required raceID}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'raceID2': raceID};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<MissionComplete>>>(Options(
  ...
  Future<HttpResponse<RaceResult>> updateStatusMisCom(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(missionComStatus.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(

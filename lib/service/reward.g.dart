...
class _RewardService implements RewardService {
  _RewardService(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<HttpResponse<Reward>> reward(rewardDto) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(rewardDto.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<Reward>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Reward.fromJson(_result.data!);
  ...
  @override
  Future<HttpResponse<List<RewardResult>>> rewardAll() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
